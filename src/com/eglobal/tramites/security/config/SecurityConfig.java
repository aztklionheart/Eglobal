package com.eglobal.tramites.security.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	@Value("${idp.app-entityId}")
	private String entityId;

	@Value("${idp.app-baseUrl}")
	...
	@Value("${server.ssl.key-storePass}")
	private String storePass;

	@Value("${server.ssl.key-alias}")
	private String alias;
	
	@Value("${server.ssl.key-pass}")
	private String pass;
	
	@Value("${server.ssl.key-storeFile}")
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
	    	.antMatchers("/page/TipoCambio/Checker.xhtml").hasAnyAuthority("FIX_SDI","FIX_CHECKER")
	    	.antMatchers("/page/TipoCambio/ConsultaTc.xhtml").hasAnyAuthority("FIX_SDI","FIX_EGLOBAL")
	    	.antMatchers("/page/TipoCambio/Maker.xhtml").hasAnyAuthority("FIX_SDI","FIX_MAKER")
	    	.anyRequest().authenticated();
	...
	public KeyManager keyManager() {
		...
		Resource storeFile = loader.getResource(getStoreFile());
		
		Map<String, String> passwords = new HashMap<>();
		passwords.put(getAlias(), getPass());
		return new JKSKeyManager(storeFile, getStorePass(), passwords, getAlias());
	}
	...
	public ExtendedMetadataDelegate idpMetadata() throws MetadataProviderException, ResourceException {
		...
		HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(backgroundTaskTimer, new HttpClient(), getMetadataURL());
